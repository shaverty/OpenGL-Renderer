...
class vtk441MapperPart1 : public vtk441Mapper //color render
{
 public:
   ...
   void init()
   {
	...
	glNewList(displayList, GL_COMPILE);
	  ...
	  int indx;
	  unsigned char* colorBuffer = GetColorMap();
	    cout  << endl;
	    ...
	    for (int i =0; i<triangles.size(); i++)
	    {
	      ...
	      indx= ceil(triangles[i].fieldValue[0]*255) *3;
	      glColor3ub(colorBuffer[indx],colorBuffer[indx+1], colorBuffer[indx+2]);
	      ...
	      indx= ceil(triangles[i].fieldValue[1]*255) *3;
	      glColor3ub(colorBuffer[indx],colorBuffer[indx+1], colorBuffer[indx+2]);
	      ...
	      indx= ceil(triangles[i].fieldValue[2]*255) *3;
	      glColor3ub(colorBuffer[indx],colorBuffer[indx+1], colorBuffer[indx+2]);
 ...
 public:
   ...
   void init()
   {
	...
	glNewList(displayList, GL_COMPILE);
	  ...
	  glTexImage1D(GL_TEXTURE_1D, 0, GL_RGB, 256, 0, GL_RGB, GL_UNSIGNED_BYTE, colorBuffer);
	  glEnable(GL_COLOR_MATERIAL);
